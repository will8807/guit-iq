/**
 * Variant B — "Fretboard card"
 *
 * Leans into the guitar aesthetic with a decorative fret-wire stripe across
 * the top, warm amber/brown tones instead of indigo, and a card-based layout
 * that feels more tactile / physical.
 */
    ...
    <main className="min-h-screen bg-[#100c06] text-white flex flex-col items-center justify-center gap-6 px-6 py-12">
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        <h1 className="text-5xl font-black tracking-tight">
          <span className="text-amber-400">Guit</span>IQ
        </h1>
      ...
      <div className="w-full max-w-xs bg-zinc-900 border border-zinc-700/50 rounded-2xl p-5 flex flex-col gap-3 shadow-xl">
        <Link
          href="/session"
          className="w-full text-center py-4 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 rounded-xl text-lg font-black text-black transition-all shadow-md shadow-amber-900/40 hover:-translate-y-0.5 active:translate-y-0"
        >
          🎸 Start Training
        </Link>
